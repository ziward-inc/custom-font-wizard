...
Custom Font Wizard는 두 Variable Font의 `cmap` 합집합을 분석하고, 선택한 Unicode group만으로 새 Variable Font를 만드는 Rust TUI입니다. Base에 정상 outline이 있으면 Base glyph를 유지하고, Base glyph가 누락됐거나 비어 있으면 Donor glyph로 채웁니다.
...
Copyright 2026 Ziward, Inc. [Apache License, Version 2.0](LICENSE)에 따라 배포됩니다.
